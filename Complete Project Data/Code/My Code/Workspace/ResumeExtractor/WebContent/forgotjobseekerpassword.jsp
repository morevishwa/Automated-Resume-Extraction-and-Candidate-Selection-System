...
<br></br>
<div class="welcome">
<form   style="border: 1" action="forgotJobSeekerPassword" method = "post" onSubmit="return validateforgotpassword(this)">
							...
							<tr>
							<td><input type="submit" name="Submit" value="Send"></input></td>
							</tr>							
							</TABLE>
							</form>
</div>
