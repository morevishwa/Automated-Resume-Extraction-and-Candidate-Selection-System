...
<div class="welcome">
<form   style="border: 1" action="Registration" method = "post" onSubmit="return validateReg(this)">
							...
							<tr>
								<td>Birth Date</td>
								<td>
									<!-- <input type="text" name="birthdate">  dd/mm/yyyy -->
									<input type="text" id="datepicker" name="birthdate"/>
								</td>
							</tr>
							<tr>
								<td>Gender</td>
								<td><select STYLE="width: 70px" name="gender">
